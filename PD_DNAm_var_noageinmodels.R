...
DNAm_vars <- c("mAccel_Hovath", "mAccel_Hannum", "mAccel_PhenoAge", "tnsc","irS","hypoSC","pcgtAge")
...
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/DNAm_var")
...
for (timept in c("BL","V04","V06","V08")){
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
    ...
    cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
    ...
    file_output_prefix = paste0("Model1_noage_",timept), # string to attach to saved file names
  ...
  ## Model2: Univar + batch
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="DX_new_char + weird_batch", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
               group_var="DX_new_char", # what is the grouping variable
               ref_group="HC", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model2_noage_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 3.5, # size of the ring value labels
               axis_label_size_user = 2,
               plot_title = paste0("PDvsHC: ",timept),
  ...
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model3_noage_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 3.5, # size of the ring value labels
               axis_label_size_user = 2,
               plot_title = paste0("PDvsHC: ",timept),
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="DX_new_char + weird_batch  + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
               group_var="DX_new_char", # what is the grouping variable
               ref_group="HC", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model4_noage_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 3.5, # size of the ring value labels
               axis_label_size_user = 2,
               plot_title = paste0("PDvsHC: ",timept),
  ...
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="DX_new_char  + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
               group_var="DX_new_char", # what is the grouping variable
               ref_group="HC", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model5_noage_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 3.5, # size of the ring value labels
               axis_label_size_user = 2,
               plot_title = paste0("PDvsHC: ",timept),
...
## Model2: Univar + batch
DeconvoRadar(df=pheno, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char + weird_batch + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char + weird_batch  + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
## Model5: Multivar + batch (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char  + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
DeconvoRadar(df=pheno, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char*Sample_Time + weird_batch  + is.Female + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
             ...
             save_output_csv = TRUE, # save the results in csv table
             save_output_pdf = TRUE, # save a pdf version of the plot
             file_output_prefix = paste0("Model6_noage_",timept), # string to attach to saved file names
             output_csv_dir = getwd(), # path to folder to save files in
             grid_label_size_user = 3.5, # size of the ring value labels
             axis_label_size_user = 2,
             plot_title = paste0("PDvsHC: ",timept),
...
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char*Sample_Time  + is.Female + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
             ...
             save_output_csv = TRUE, # save the results in csv table
             save_output_pdf = TRUE, # save a pdf version of the plot
             file_output_prefix = paste0("Model7_noage_",timept), # string to attach to saved file names
             output_csv_dir = getwd(), # path to folder to save files in
             grid_label_size_user = 3.5, # size of the ring value labels
             axis_label_size_user = 2,
             plot_title = paste0("PDvsHC: ",timept),
...
## Model2: Univar + batch
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive + weird_batch + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive + weird_batch  + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model5: Multivar + batch (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive  + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model6: Multivar + batch + interaction
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive*Sample_Time + weird_batch  + is.Female + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model7: Multivar + interaction (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive*Sample_Time  + is.Female + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
