...
try(dir.create("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps"))
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps")
...
pheno$CONLRRK2 <- ifelse(is.na(pheno$CONLRRK2), "N/A", ifelse(pheno$CONLRRK2 == 0, "No", "Yes"))
pheno$CONGBA <- ifelse(is.na(pheno$CONGBA), "N/A", ifelse(pheno$CONGBA == 0, "No", "Yes"))
pheno$CONHPSM <- ifelse(is.na(pheno$CONHPSM), "N/A", ifelse(pheno$CONHPSM == 0, "No", "Yes"))
pheno$CONSNCA <- ifelse(is.na(pheno$CONSNCA), "N/A", ifelse(pheno$CONSNCA == 0, "No", "Yes"))
pheno$CONRBD <- ifelse(is.na(pheno$CONRBD), "N/A", ifelse(pheno$CONRBD == 0, "No", "Yes"))

##### PD LRRK
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps")
try(dir.create("PD_LRRKposvsLRRKneg"))
setwd("PD_LRRKposvsLRRKneg")
tmp_cols <- c(No='black', Yes="#C56124")
pheno1 <- pheno[pheno$DX_new_char == "PD" & pheno$CONLRRK2 != "N/A",]
...
for (timept in c("BL","V04","V06","V08")){
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
    reg_model="CONLRRK2", # the right hand side of the regression model equation
    ...
    group_var="CONLRRK2", # what is the grouping variable
    ...
    file_output_prefix = paste0("Model1_newbatch_",timept), # string to attach to saved file names
    ...
    plot_title = paste0("PD_LRRKposvsLRRKneg: ",timept),
  ...
  ## Model2: Univar + batch
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONLRRK2 + weird_batch", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONLRRK2", # what is the grouping variable
               ref_group="No", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model2_newbatch_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("PD_LRRKposvsLRRKneg: ",timept),
  ...
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model3_newbatch_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("PD_LRRKposvsLRRKneg: ",timept),
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONLRRK2 + weird_batch + rundate_binary + BL_age + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONLRRK2", # what is the grouping variable
               ref_group="No", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model4_newbatch_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("PD_LRRKposvsLRRKneg: ",timept),
  ...
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONLRRK2 + BL_age + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONLRRK2", # what is the grouping variable
               ref_group="No", # what is the reference group
               ...
               save_output_csv = TRUE, # save the results in csv table
               save_output_pdf = TRUE, # save a pdf version of the plot
               file_output_prefix = paste0("Model5_newbatch_",timept), # string to attach to saved file names
               output_csv_dir = getwd(), # path to folder to save files in
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("PD_LRRKposvsLRRKneg: ",timept),
...
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONLRRK2 + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
...
## Model2: Univar + batch
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONLRRK2 + weird_batch + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONLRRK2", # what is the grouping variable
             ref_group="No", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONLRRK2 + weird_batch + rundate_binary + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONLRRK2", # what is the grouping variable
             ref_group="No", # what is the reference group
...
## Model5: Multivar + batch (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONLRRK2 + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONLRRK2", # what is the grouping variable
             ref_group="No", # what is the reference group
...
##### Prod LRRK
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps")
try(dir.create("Prod_LRRKposvsLRRKneg"))
setwd("Prod_LRRKposvsLRRKneg")
tmp_cols <- c(No='black', Yes="#3971B5")
pheno1 <- pheno[pheno$DX_new_char == "Prod" & pheno$CONLRRK2 != "N/A",]
...
for (timept in c("BL","V04","V06","V08")){
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               ...
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("Prod_LRRKposvsLRRKneg: ",timept),
                legend_text_size_user = 1,
               make_sum_equal_one = FALSE, # adjust proportions so they add to 1
               confint.level=0.95)
...
##### PD GBA
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps")
try(dir.create("PD_GBAposvsGBAneg"))
setwd("PD_GBAposvsGBAneg")
tmp_cols <- c(No='black', Yes="#C56124")
pheno1 <- pheno[pheno$DX_new_char == "PD" & pheno$CONGBA != "N/A",]
...
for (timept in c("BL","V04","V06","V08")){
  ...
  ## Model1: Univar
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONGBA", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONGBA", # what is the grouping variable
               ref_group="No", # what is the reference group
               case_groups="Yes", # which groups do you want to plot against the reference (reccomend no more than 2 or 3)
               group_colours_user = tmp_cols, # colors for plot, name the vector the names of the groups
               save_output_csv = TRUE, # save the results in csv table
               ...
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("PD_GBAposvsGBAneg: ",timept),
                legend_text_size_user = 1,
               make_sum_equal_one = FALSE, # adjust proportions so they add to 1
               confint.level=0.95)
  ...
  ## Model2: Univar + batch
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONGBA + weird_batch", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONGBA", # what is the grouping variable
               ref_group="No", # what is the reference group
  ...
  ## Model4: Multivar + batch
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONGBA + weird_batch + rundate_binary + BL_age + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONGBA", # what is the grouping variable
               ref_group="No", # what is the reference group
  ...
  ## Model5: Multivar + batch (subset out bad batch)
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="CONGBA + BL_age + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
               group_var="CONGBA", # what is the grouping variable
               ref_group="No", # what is the reference group
...
## Model1: Univar
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONGBA + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONGBA", # what is the grouping variable
             ref_group="No", # what is the reference group
...
## Model2: Univar + batch
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONGBA + weird_batch + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONGBA", # what is the grouping variable
             ref_group="No", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno1, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONGBA + rundate_binary +  weird_batch + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONGBA", # what is the grouping variable
             ref_group="No", # what is the reference group
...
## Model5: Multivar + batch (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="CONGBA + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=cell_types2, # which cell types do you want to plot, list in the order you want them
             group_var="CONGBA", # what is the grouping variable
             ref_group="No", # what is the reference group
...
##### Prod LRRK
setwd("//dartfs.dartmouth.edu/rc/lab/S/SalasLab/PD/Processed_data/Feb2023/Genetic_comps")
try(dir.create("Prod_GBAposvsGBAneg"))
setwd("Prod_GBAposvsGBAneg")
tmp_cols <- c(No='black', Yes="#3971B5")
pheno1 <- pheno[pheno$DX_new_char == "Prod" & pheno$CONGBA != "N/A",]
...
for (timept in c("BL","V04","V06","V08")){
  ...
  DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               ...
               grid_label_size_user = 6.2, # size of the ring value labels
               axis_label_size_user = 5.5,
               plot_title = paste0("Prod_GBAposvsGBAneg: ",timept),
                legend_text_size_user = 1,
               make_sum_equal_one = FALSE, # adjust proportions so they add to 1
               confint.level=0.95)
