...
for (timept in c("BL","V04","V06","V08")){
  ...
  DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
               reg_model="DX_new_char + rundate_binary + BL_age + is.Female", # the right hand side of the regression model equation
               model_type="lm", # the type of model you want (options: lm, lmer)
               cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
               group_var="DX_new_char", # what is the grouping variable
               ref_group="HC", # what is the reference group
...
## Model2: Univar + batch
DeconvoRadar(df=pheno, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char + rundate_binary + weird_batch + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
DeconvoRadar(df=pheno, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char*Sample_Time + weird_batch + rundate_binary + BL_age + is.Female + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="DX_new_char + rundate_binary + weird_batch + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="DX_new_char", # what is the grouping variable
             ref_group="HC", # what is the reference group
...
## Model2: Univar + batch
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive + weird_batch + rundate_binary + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model4: Multivar + batch
DeconvoRadar(df=pheno2, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive + weird_batch + rundate_binary + BL_age + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
...
## Model5: Multivar + batch (subset out bad batch)
DeconvoRadar(df=pheno3, # data frame with all covariate data, colnames should match variable names within reg.model and cell.types 
             reg_model="Prod_Convert_Relavtive + BL_age + rundate_binary + is.Female + Sample_Time + (1|PATNO)", # the right hand side of the regression model equation
             model_type="lmer", # the type of model you want (options: lm, lmer)
             cell_types=DNAm_vars, # which cell types do you want to plot, list in the order you want them
             group_var="Prod_Convert_Relavtive", # what is the grouping variable
             ref_group="Pre-conversion", # what is the reference group
